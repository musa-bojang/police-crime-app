...
class _CaptureFormScreenState extends State<CaptureFormScreen> {
  ...
  Future<void> _save() async {
    ...
    // Grab the sync service now, before any async gaps use context.
    ...
    // Sync immediately so it uploads as soon as there's a connection, instead
    // of waiting for a manual refresh. Fire-and-forget; it self-guards offline.
    sync.syncNow();
